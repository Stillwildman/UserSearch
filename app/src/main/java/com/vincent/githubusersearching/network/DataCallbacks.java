...
public class DataCallbacks implements ApiUrl {
    ...
    public static void getGitHubUsers(String keyword, int perPage, int page, OnDataGetCallback<ItemSearchResult> callback) {
        String clientId = AppController.getInstance().getString(R.string.github_client_id);
        String clientSecret = AppController.getInstance().getString(R.string.github_client_secret);
